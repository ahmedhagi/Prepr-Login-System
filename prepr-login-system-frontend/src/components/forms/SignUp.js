          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 form signup-form px-0">
              ...
              <div className="form-content">
                <div className="form-field position-relative">
                  <label for="firstName">
                    <span className="label-icon">
                      <img
                        alt=""
                        src="https://d3f06rtlkr354b.cloudfront.net/public/front/img/name.png"
                      />
                    </span>
                    First name
                  </label>
                ...
                <div className="form-field position-relative">
                  <label for="password">
                    <span className="label-icon">
                      <img
                        alt=""
                        src="https://d3f06rtlkr354b.cloudfront.net/public/front/img/pass-check.png"
                      />
                    </span>
                    Confrim password
                  </label>
                ...
                <div className="form-field position-relative">
                  <label for="email">
                    <span className="label-icon">
                      <img
                        alt=""
                        src="https://d3f06rtlkr354b.cloudfront.net/public/front/img/email.png"
                      />
                    </span>
                    Email
                  </label>
                ...
                <div className="form-field">
                  <small className="float-end optional">
                    {" "}
                    <i>Optional</i>
                  </small>
                  <select
                ...
                <div className="text-center bottom-links">
                  ...
                  <a href="#link">Organization register</a>
                </div>
              </div>
            </div>
          </div>
